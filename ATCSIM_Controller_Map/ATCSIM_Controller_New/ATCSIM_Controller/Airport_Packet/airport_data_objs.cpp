...
void AirportData::SetAirportName(std::string szAirportName)
{
	m_szAirportName = szAirportName;
}

void AirportData::SetAirportCode(std::string szCode)
{
...
std::string AirportData::GetAirportName()
{
	return m_szAirportName;
}

std::string AirportData::GetAirportCode()
{
	return m_szAirportCode;
}
...
void FixpointData::SetFixpointName(std::string szFixpointName)
{
...
std::string FixpointData::GetFixpointName()
{
	return m_szFixpointName;
}
...
void RoadData::SetRoadName(std::string szRoadName)
{
...
std::vector<boost::shared_ptr<RoadFixpointData> >&  RoadData::GetFixpoints()
{
...
void RoadData::SetFixpoints( std::vector<boost::shared_ptr<RoadFixpointData> >& vData )
{
...
void GateData::SetGateName( std::string szName )
{
...
void InRunwayLineData::SetInRunwayLineName(std::string szName)
{
...
std::string InRunwayLineData::GetInRunwayLineName()
{
	return m_szInRunwayLineName;
}
...
void VacateLineData::SetVacateLineName(std::string szName)
{
...
std::string VacateLineData::GetVacateLineName()
{
...
void RunwayData::SetRunwayName(std::string szRunwayName)
{
...
void RunwayData::SetInRunwayLines( std::vector<boost::shared_ptr<InRunwayLineData> >& vInRunwayLine )
{
	m_vInRunwayLine.clear();
	m_vInRunwayLine = vInRunwayLine;
}

void RunwayData::SetVacateLines( std::vector<boost::shared_ptr<VacateLineData> >& vVacateLine )
{
	m_vVacateLine.clear();
...
std::vector<boost::shared_ptr<InRunwayLineData> >& RunwayData::GetInRunwayLines()
{
	return m_vInRunwayLine;
}

std::vector<boost::shared_ptr<VacateLineData> >& RunwayData::GetVacateLines()
{
...
void Tower::SetTowerName( std::string strTowerName )
{
...
void AirportModel::SetModelName(std::string strModelName )
{
	m_strModelName = strModelName;
}

void AirportModel::SetModelFile(std::string strModelFile )
{
...
std::string Sid::GetDisplayLabel()
{
	return m_strSidName;
}
...
std::string Star::GetDisplayLabel()
{
...
std::string Macro::GetDisplayLabel()
{
...
std::string MacroGroup::GetDisplayLabel()
{
...
std::string Hold::GetDisplayLabel()
{
	return m_szHoldName;
}
...
std::string Miss::GetDisplayLabel()
{
	return m_szMissName;
}
...
std::string LightGroup::GetDisplayLabel()
{
...
std::string Light::GetDisplayLabel()
{
	return "";
}
...
std::string LightCollection::GetDisplayLabel()
{
...
std::string LightGroupDetail::GetDisplayLabel()
{
	return "";
}