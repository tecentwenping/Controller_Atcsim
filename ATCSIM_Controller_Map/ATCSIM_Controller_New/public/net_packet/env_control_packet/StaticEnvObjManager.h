...
#ifndef _STATIC_ENV_OBJ_MANAGER_PACKET_H_
#define _STATIC_ENV_OBJ_MANAGER_PACKET_H_
...
class StaticEnvObjManagerPacket : public CSerial_Base
{
	PKT_DECLARE_DYNCREATE(StaticEnvObjManagerPacket);
public: 	
	StaticEnvObjManagerPacket ();
