...
public:
	...
	void SetAirportName(string szAirportName);
	void SetAirportCode(string szCode);
...
public:
	...
	void SetFixpointName(string szFixpointName);
	void SetAirportID(int iAirportID);
...
public:
	...
	void SetRoadID(int iRoadID);
	void SetAirportID(int iAirportID);
	void SetRoadName(string szRoadName);
	...
	void  SetFixpoints(vector<boost::shared_ptr<RoadFixpointData> >& vData);
	vector<boost::shared_ptr<RoadFixpointData> >& GetFixpoints();
	void ReadFromBuffer(const char* pBuffer, int &iOffSize);
	void WriteToBuffer(char* pBuffer, int &iOffSize);
	int GetBufferSize();
...
public:
	...
	vector<boost::shared_ptr<RoadFixpointData> > m_vRoadFixpoints;	/*构成道路的点*/
...
public:
	...
	vector<boost::shared_ptr<RouteFixpointRoad> > m_vRouteFixpointRoad;	/*构成路线的固定点或者道路*/
...
public:
	...
	void SetAirportID(int iAirportID);
	void SetGateName(string szName);
	void SetRoadID(int iRoadID);
...
public:
	...
	void SetInRunwayLineName(string szName);
...
public:
	...
	void SetAirportID(int iAirportID);
	void SetVacateLineName(string szName);
	void SetSequence(int iSequence);
	void SetRunwayID(int iRunwayID);
	void SetRoadID(int iRoadID);
	void SetStartPointID(int iStartPointID);
...
public:
	...
	void SetRunWayID(int iRunwayID);
	void SetAirportID(int iAirportID);
	void SetRunwayName(string szRunwayName);
	...
	void SetInRunwayLines(vector<boost::shared_ptr<InRunwayLineData> >& vInRunwayLine);
	void SetVacateLines(vector<boost::shared_ptr<VacateLineData> >& vVacateLine);
	...
	vector<boost::shared_ptr<InRunwayLineData> >& GetInRunwayLines();
	vector<boost::shared_ptr<VacateLineData> >& GetVacateLines();
...
public:
	...
	void SetAirportID(int iAirportID);
	void SetIconID(int iIconID);
	void SetTowerName(string strTowerName);
...
public:
	...
	int m_iAirportID;		          /* 机场ID */
	int m_iRunwayID;	              /* 跑道ID */
	vector<RoutePt> m_vecRoutePt;     /* 离场程序包括的航路点 */
};
...
public:
	...
	int m_iAirportID;		          /* 机场ID */
	int m_iRunwayID;	              /* 跑道ID */
	vector<RoutePt> m_vecRoutePt;     /* 进场程序包括的航路点 */
};
...
public:
	...
	int m_iRunwayID;		/*跑道ID */
	vector<RoutePt> m_vecRoutePt;     /* 复飞程序包括的航路点 */
};
